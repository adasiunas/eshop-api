...
namespace eshopAPI.Tests.DataAccess.DiscountRepositoryTests
{
    public class GetDiscountForSubCategory
    {
        ...
        {
            Discount discount = await _repository.GetDiscountForSubCategory(1);
        ...
        {
            Discount discount = await _repository.GetDiscountForSubCategory(5);
