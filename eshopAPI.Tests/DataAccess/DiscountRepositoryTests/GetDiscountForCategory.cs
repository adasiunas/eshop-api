...
namespace eshopAPI.Tests.DataAccess.DiscountRepositoryTests
{
    public class GetDiscountForCategory
    {
        ...
        {
            Discount discount = await _repository.GetDiscountForCategory(3);
        ...
        {
            Discount discount = await _repository.GetDiscountForCategory(5);
