...
namespace eshopAPI.Tests.Controllers.AccountControllerTests
{
    public class ResetPassword
    {
        ...
        public ResetPassword(ITestOutputHelper output)
        {
            _output = output;
        }
        ...
        public async void ConfirmEmail_Test(bool validUser, bool successfulReset)
        {
            ShopUser user = null;
            if (validUser)
            ...
            Mock<UserManager<ShopUser>> userManagerMock = MockUserManager(user, successfulReset);
            ...
            {
                Token = EncodeHelper.Base64Encode("1"),
                UserId = "a",
        ...
        Mock<UserManager<ShopUser>> MockUserManager(ShopUser user, bool successfulConfirm)
        {
            ...
            userManagerMock.Setup(o => o.ResetPasswordAsync(user, It.IsAny<string>(), It.IsAny<string>()))
                .ReturnsAsync(successfulConfirm ? IdentityResult.Success : IdentityResult.Failed(new IdentityError { Description = "Failed" }));
